...
export default class TransactionSelectionTab extends Component {
  constructor(props) {
    super(props);
    this.state = {
      date : props.screenProps[0], // dates from TransactionSelection
  ...
  selectCheckBox(index, text, stateKey){
    ...
    this.props.screenProps[1](date); // calling updateDates from TransactionSelection
  }
  ...
  render() {
    ...
    getData = (text, index) => {
      if(state.routeName != 'CUSTOM') {
        return (
          <TouchableOpacity style={TransactionSelStyles.tabItemCon} onPress={this.selectCheckBox.bind(this, index, text)}
                            activeOpacity={0.75}>
            <Icon style={TransactionSelStyles.radioIcon}
            ...
            <Text style={[TransactionSelStyles.DbSelectionText, TransactionSelStyles.tabItemTxt]}>{text}</Text>
          </TouchableOpacity>
        );
      }else{
        return (
          <ViewContainer style={TransactionSelStyles.tabContainerCustom}>
            <TouchableWithoutFeedback>
              <TouchableOpacity style={TransactionSelStyles.textCon}
                ...
                <Text style={TransactionSelStyles.text}>TO</Text>
              </TouchableOpacity>
            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback>
              <TouchableOpacity style={TransactionSelStyles.textCon}
                ...
                <Text style={TransactionSelStyles.text}>FROM</Text>
              </TouchableOpacity>
            </TouchableWithoutFeedback>
    ...
    const Day = () => (
      <ViewContainer style={TransactionSelStyles.tabContainer}>
